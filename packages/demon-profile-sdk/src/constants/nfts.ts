...
const Nfts: Nft[] = [
  ...
  {
    name: "Sunny",
    description: "Sunny is always cheerful when there are demons around. Smile!",
    images: {
      lg: "sunny-lg.png",
      md: "sunny-md.png",
      sm: "sunny-sm.png",
  ...
  {
    name: "Churro",
    description: "Don't let that dopey smile deceive you... Churro's a master DEMON chef!",
    images: {
      lg: "churro-lg.png",
      md: "churro-md.png",
      sm: "churro-sm.png",
  ...
  {
    name: "Dollop",
    description: "Nommm... Oh hi, I'm just meditating on the meaning of DEMON.",
    images: {
      lg: "dollop-lg.png",
      md: "dollop-md.png",
      sm: "dollop-sm.png",
  ...
  {
    name: "Twinkle",
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's DEMON)",
    images: {
      lg: "twinkle-lg.png",
      md: "twinkle-md.png",
      sm: "twinkle-sm.png",
  ...
  {
    name: "Blueberries",
    description: "These bunnies like their demons with blueberries. What's your favorite topping?",
    images: {
  ...
  {
    name: "Circular",
    description: "Love makes the world go 'round... but so do demons. And these bunnies know it.",
    images: {
      lg: "circular-lg.png",
      md: "circular-md.png",
      sm: "circular-sm.png",
  ...
  {
    name: "Sparkle",
    description: "It’s sparkling syrup, demons, and even lottery tickets! This bunny really loves it.",
    images: {
      lg: "sparkle-lg.png",
      md: "sparkle-md.png",
      sm: "sparkle-sm.png",
