...
class DemonProfileSdk {
   ...
   * API repo - https://github.com/demonswap/demon-profile-api
   */
   ...
   * Contract repo - https://github.com/demonswap/demon-contracts/tree/master/projects/profile-nft-gamification
   */
   ...
   * from DemonProfile contract.
   * NFT's bunnyId is retrieved from DemonBunnies contract and mapped to static NFT data stored in constant.
   * Contracts repo - https://github.com/demonswap/demon-contracts/tree/master/projects/profile-nft-gamification
   */
  getProfile = async (address: string): Promise<GetProfileResponse> => {
    try {
      ...
      if (isActive) {
        ...
        const avatar = nft ? `https://demonswap.fi/images/nfts/${nft.images.sm}` : undefined;
        ...
        Cookies.set(
          ...
          { domain: "demonswap.fi", secure: true, expires: 30 }
        );
      }
...
export default DemonProfileSdk;
