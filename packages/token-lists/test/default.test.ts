...
import currentDemonswapDefaultList from "../lists/demonswap-default.json";
import currentDemonswapExtendedtList from "../lists/demonswap-extended.json";
import currentDemonswapTop15List from "../lists/demonswap-top-15.json";
import currentDemonswapTop100tList from "../lists/demonswap-top-100.json";
import { buildList, VersionBump } from "../src/buildList";

const currentLists = {
  "demonswap-default": currentDemonswapDefaultList,
  "demonswap-extended": currentDemonswapExtendedtList,
  "demonswap-top-100": currentDemonswapTop100tList,
  "demonswap-top-15": currentDemonswapTop15List,
};
...
expect.extend({
  ...
  toBeValidLogo(token) {
    ...
    const refersToLocalLogo = token.logoURI === `https://tokens.demonswap.finance/images/${token.address}.png`;
...
describe.each([["demonswap-default"], ["demonswap-extended"], ["demonswap-top-100"], ["demonswap-top-15"]])(
  "buildList %s",
  (listName) => {
